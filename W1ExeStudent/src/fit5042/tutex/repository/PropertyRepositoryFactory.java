...
public class PropertyRepositoryFactory {
    ...
    private static PropertyRepository createInstance() {
        try {
            ...
            repositoryProperties.loadFromXML(new FileInputStream(new File("E:\\workspace\\java_ee\\W1ExeStudent\\bin\\fit5042\\tutex\\repository\\repository-settings.properties")));
